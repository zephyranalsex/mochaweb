      ...
      >
        {lines.map((l, i) =>
          l.kind === "cmd" ? (
            ...
            <div
              className={`t-line t-res${l.kind === "err" ? " err" : ""}`}
              key={i}
            >
              {l.text}
            </div>
      ...
      <div className="cmd-top">
        <div>
          ...
          <p data-reveal style={rd(".1s")}>
            A handful of the basics, printed straight from the bot's own
            mouth — or run{" "}
            <code className="cmd-inline">mocha help</code> in chat for the
            full list. The terminal on the right is live. go on.
          </p>
        </div>
      ...
      <div className="cta-grid">
        <div className="cta-copy">
          ...
          <p className="cta-sub" data-reveal style={rd(".2s")}>
            Join the support server for updates, bug reports, and a direct
            line if something breaks. It's where Mocha actually spends its
            time.
          </p>
          ...
          >
            ...
            >
              ...
              <span className="plate plate--outline">
                Join Discord &gt;
              </span>
            </a>

            <a className="hero-text-link" href="/docs">
    ...
    <footer className="mocha-footer" id="footer">
      ...
      <div className="footer-main">
        <div className="footer-brand">
          ...
          <div className="footer-brand-copy">
            A Discord bot for communities that want useful tools
            without turning the server into a dashboard.
          </div>
        </div>
      ...
      <div className="footer-bottom">
        <div className="footer-legal">
          &copy; 2026 Mocha. All rights reserved by{" "}
          <a className="footer-zephyr" href="/zephyr">
            zephyr
          </a>
          .
        </div>
